    """
    Minesweeper Cli Vuviuh2
    =======================
    Zero-dependency terminal game where players solve challenges in real time.
    ...
    APP_NAME    = "Minesweeper Cli Vuviuh2"
    APP_VERSION = "1.0.0"
...
return {"score": score, "rounds": guessed_in, "won": score > 0}
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Zero-dependency terminal game where players solve challenges in real time.")
